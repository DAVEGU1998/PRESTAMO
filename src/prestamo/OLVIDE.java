...
public class OLVIDE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("correctamente tus datos se bloqueara la cuenta.");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 540, 30));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(204, 0, 0));
        jLabel4.setText("Para poder recuperar el usuario debes ingresar los datos personales con el fin de verificar que seas tu");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 560, 30));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(204, 0, 0));
        jLabel5.setText("despues de validar la informacion te permitira cambiar la contraseña, si a los 3 intentos no ingresaste");
