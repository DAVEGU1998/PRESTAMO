...
public class PERFIL extends JPanel {
    ...
    String sql = "SELECT CEDULA, NOMBRE, APELLIDO, CORREO, CAMPUS FROM USUARIOS WHERE CORREO = ?";
...
public void setDatosUsuario(String nombreUsuario, String correoUsuario) {
    ...
    String sqlVerificar = "SELECT CONTRASEÑA FROM USUARIOS WHERE CEDULA = ?";
    
    try {
        // Verificación de contraseña actual
        PreparedStatement pstVerificar = conexion.prepareStatement(sqlVerificar);
        pstVerificar.setString(1, cedula.getText().trim());
    ...
    private void u_guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_u_guardar1ActionPerformed
        ...
        String sql = "UPDATE USUARIOS SET NOMBRE = ?, APELLIDO = ?, CORREO = ?, CAMPUS = ? WHERE CEDULA = ?";
        ...
        try {
            ...
            pst.setString(5, cedula.getText().trim());
